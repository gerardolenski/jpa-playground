...
class PersistablePostGenerator {

    private final AuthorProvider authorProvider;
    private final CategoryProvider categoryProvider;
    private final SentenceProvider sentenceProvider;
    private final PersistablePostRepository postRepository;
    ...
    private PersistablePostEntity generatePost(int i) {
        return new PersistablePostEntity(authorProvider.drawAuthor(),
