...
import org.gol.jpaplayground.infrastructure.post.relation.manytoone.PostCommentMTORepository;
import org.gol.jpaplayground.infrastructure.post.relation.manytoone.PostMTOAdapter;
import org.gol.jpaplayground.infrastructure.post.relation.manytoone.PostMTORepository;
...
class AddCommentPerfTest {
    ...
    @Autowired
    PostMTORepository postepository;
    @Autowired
    PostCommentMTORepository postCommentRepository;
    @Autowired
    ...
    void add10MoreCommentsTo500kPopulation() {
        var postId = UUID.fromString("1d816b90-7171-4e4e-8e08-bf020b044139");
        var population = 10;
        var stats = new DbStats();
